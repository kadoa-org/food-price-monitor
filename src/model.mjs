...
export const curated = [
  ...
  { slug: 'eggs', name: 'Eggs', singular: 'Egg', emoji: '🥚', featured: false, news: /\beggs?\b/i, matches: ['Shell Eggs', 'Egg'], preferSeries: (s) => s.market === 'New York' && /^Large\b/.test(s.product), description: 'Shell eggs by size, colour and housing: New York volume prices to retail buyers and the national weighted index, in dollars per dozen.' },
